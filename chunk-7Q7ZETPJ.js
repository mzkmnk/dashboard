...
// src/app/internal/data/task.data.ts
var sampleTasks = [
  {
    title: "\u30AB\u30EC\u30F3\u30C0\u30FC\u306E\u4F5C\u6210",
...
// src/app/internal/main/store/main.signal-store.ts
var initialState = {
  common: {
    isLoading: false
  },
...
var MainSignalStore = signalStore(withDevtools("[main signal store]"), withState(initialState), withRedux({
  actions: {
    taskDataLoad: payload(),
    taskDataLoadSuccess: payload(),
  ...
  reducer(actions, on) {
    on(actions.taskDataLoad, (signalStore2) => patchState(signalStore2, { common: { isLoading: true } }));
    on(actions.taskDataLoadSuccess, (signalStore2, { response }) => {
      const data = {
        dashboard: {
          TODO: [],
          PROGRESS: [],
      ...
      patchState(signalStore2, { common: { isLoading: false }, data });
    });
    on(actions.taskDataUpdate, (signalStore2, { sidebarLabel, group, idx, progress }) => {
      patchState(signalStore2, (signalState) => {
        const tasks = signalState.data[sidebarLabel][group];
        ...
        return __spreadProps(__spreadValues({}, signalState), {
          data: __spreadProps(__spreadValues({}, signalState.data), {
            [sidebarLabel]: __spreadProps(__spreadValues({}, signalState.data[sidebarLabel]), {
              [group]: tasks
            })
          })
        });
    ...
    on(actions.taskAdd, (signalStore2, { group, sidebarLabel }) => patchState(signalStore2, (signalState) => {
      const tasks = signalState.data[sidebarLabel][group];
      tasks.unshift({
        title: "",
        description: "",
  ...
  effects(actions, create) {
    return {
      load$: create(actions.taskDataLoad).pipe(switchMap(() => {
...
var _c35 = (a0) => ({ "background-color": a0 });
...
function HomeComponent_For_14_For_11_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 29)(1, "div", 32)(2, "p", 33);
    \u0275\u0275text(3, "Progress");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 33);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "p-progressBar", 34);
    ...
    \u0275\u0275template(7, HomeComponent_For_14_For_11_Conditional_6_ng_template_7_Template, 0, 0, "ng-template", 20);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function HomeComponent_For_14_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, HomeComponent_For_14_For_11_Conditional_6_Template, 8, 6, "div", 29);
    \u0275\u0275elementStart(7, "p-avatarGroup");
    \u0275\u0275element(8, "p-avatar", 30)(9, "p-avatar", 31);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function HomeComponent_For_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(10, HomeComponent_For_14_For_11_Template, 10, 15, "div", 25, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r2.$tasks()[ctx_r2.$sidebarItem()][item_r2].length, " ");
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("border-color", ctx_r2.statusStyle[item_r2].mainColor);
    \u0275\u0275advance();
    \u0275\u0275styleProp("background-color", "var(--surface-ground)");
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.$tasks()[ctx_r2.$sidebarItem()][item_r2]);
  }
}
function HomeComponent_ng_template_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(2, _c35, value_r8.status === "done" ? "var(--green-600)" : "var(--surface-border)"));
  }
}
function HomeComponent_ng_template_38_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(event_r9.comment);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 2, event_r9.createdAt, "yyyy/MM/dd HH:mm"));
  }
}
var _HomeComponent = class _HomeComponent {
  constructor() {
    this.sidebarSignalStore = inject(sidebarSignalStore);
    this.mainSignalStore = inject(MainSignalStore);
    this.$sidebarItem = this.sidebarSignalStore.project.label;
    this.$tasks = this.mainSignalStore.data;
    this.sidebarTask = {
      task: void 0,
      visible: false
    };
    ...
    this.onClickUpdateProgressBar = (event, group, index) => {
...
_HomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275ProvidersFeature([MainSignalStore]), \u0275\u0275StandaloneFeature], decls: 39, vars: 6, consts: [[1, "flex", "flex-column", "main"], [1, "flex", "flex-row", "align-items-center", "justify-content-between", "ml-3"], [1, "flex", "flex-row", "align-items-center", "mr-3"], [1, "mr-3"], ["image", "assets/img/icon1.png", "size", "large", "shape", "circle"], ["image", "assets/img/icon2.jpg", "size", "large", "shape", "circle"], ["label", "M", "shape", "circle", "size", "large"], ["label", "N", "shape", "circle", "size", "large"], ["label", "K", "shape", "circle", "size", "large"], ["label", "invite", "icon", "pi pi-plus", "severity", "contrast", 3, "rounded"], [1, "dashboard", "h-full"], [1, "mx-2", "flex", "flex-row", "align-items-center", "justify-content-between"], [1, "flex", "flex-row", "align-items-center"], ["transitionOptions", "350ms cubic-bezier(0, 0, 0.2, 1)", "position", "right", "styleClass", "w-30rem border-round-3xl", 1, "custom-p-sidebar", 3, "visibleChange", "visible"], [1, "flex", "align-items-center", "justify-content-between", "w-full"], [1, "w-full", "flex", "justify-content-center", "align-items-start", "flex-column"], [1, "w-full", "flex", "justify-content-between", "align-items-center"], [1, "pi", "pi-plus", "text-xl", "opacity-80", "cursor-pointer"], [1, "w-full", "custom-p-timeline", 3, "value"], ["pTemplate", "marker"], ["pTemplate", "content"], [1, "border-round-2xl", "border-1", "px-3", "font-semibold", "opacity-60"], [1, "pi", "pi-plus", "text-xl", "opacity-80", "cursor-pointer", 3, "click"], [1, "custom-divider"], [1, "border-round-xl", "p-2", "overflow-y-scroll"], [1, "border-300", "bg-white", "border-round-2xl", "px-1", "p-1", "mb-2"], [1, "border-300", "bg-white", "border-round-2xl", "px-1", "p-1", "mb-2", 3, "click"], ["styleClass", "font-semibold text-white", 3, "rounded", "value"], [1, "opacity-60"], [1, "mb-2"], ["image", "assets/img/icon1.png", "shape", "circle"], ["image", "assets/img/icon2.jpg", "shape", "circle"], [1, "flex", "flex-row", "justify-content-between", "align-items-center"], [1, "font-semibold", "text-color-secondary"], [3, "click", "value", "color"], [1, "flex", "w-2rem", "h-2rem", "align-items-center", "justify-content-center", "text-white", "border-circle", "z-1", "shadow-1"], [1, "pi", "pi-check-circle"], [1, "flex", "flex-row", "align-items-start", "justify-content-between"], [1, "font-semibold", "m-1"], [1, "m-2"]], template: function HomeComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(35, "i", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "p-timeline", 18);
    \u0275\u0275template(37, HomeComponent_ng_template_37_Template, 2, 4, "ng-template", 19)(38, HomeComponent_ng_template_38_Template, 6, 5, "ng-template", 20);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx.$sidebarItem());
    \u0275\u0275advance(8);
...
//# sourceMappingURL=chunk-7Q7ZETPJ.js.map
