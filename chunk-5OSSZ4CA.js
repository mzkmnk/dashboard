...
var Image = class _Image {
  ...
  constructor(document2, config, cd, el) {
...
var _AuthAPI = class _AuthAPI {
  constructor() {
    ...
    this.signIn = (request) => {
      return this.http.post(`${environment.API.base}/signIn`, request);
    };
    this.signUp = (request) => {
      return this.http.post(`${environment.API.base}/signUp`, request);
    };
  }
};
_AuthAPI.\u0275fac = function AuthAPI_Factory(t) {
  return new (t || _AuthAPI)();
};
...
var RouterSignalStore = signalStore({ providedIn: "root" }, withDevtools("[router signal store]"), withState(initialState), withRedux({
  actions: {
    navigate: payload(),
  ...
  effects(actions, create) {
    ...
    return {
      navigate$: create(actions.navigate).pipe(switchMap(({ path }) => {
...
// src/app/auth/store/auth.signal-store.ts
var initialState2 = {
  signIn: {
    username: "",
    password: "",
...
var AuthSignalStore = signalStore(withDevtools("[auth signal store]"), withState(initialState2), withMethods((signalStore2, authAPI = inject(AuthAPI), routerSignalStore = inject(RouterSignalStore)) => ({
  /**
   * signInRequest
   */
  signInRequest: rxMethod(pipe(tap((request) => patchState(signalStore2, {
    signIn: __spreadProps(__spreadValues({}, request), { isLoading: true })
  })), switchMap((request) => {
    return authAPI.signIn(request).pipe(tapResponse({
      next: () => {
        routerSignalStore.navigate({ path: "internal/home" });
      },
      error: () => patchState(signalStore2, (signalState) => __spreadProps(__spreadValues({}, signalState), {
        signIn: __spreadProps(__spreadValues({}, signalState.signIn), { isLoading: false })
      }))
    }));
  }))),
  /**
   * signUpRequest
   */
  signUpRequest: rxMethod(pipe(tap((request) => patchState(signalStore2, {
    signUp: __spreadProps(__spreadValues({}, request), { isLoading: true })
  })), switchMap((request) => {
    return authAPI.signUp(request).pipe(tapResponse({
      next: (response) => {
        routerSignalStore.navigate({ path: "internal/home" });
      },
      error: () => {
        patchState(signalStore2, (signalState) => __spreadProps(__spreadValues({}, signalState), {
          signUp: __spreadProps(__spreadValues({}, signalState.signUp), { isLoading: false })
        }));
      }
    }));
  })))
...
var _AuthComponent = class _AuthComponent {
  constructor() {
    this.authSignalStore = inject(AuthSignalStore);
    this.$signInIsLoading = this.authSignalStore.signIn.isLoading;
    this.$signUpIsLoading = this.authSignalStore.signUp.isLoading;
...
_AuthComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthComponent, selectors: [["app-auth"]], standalone: true, features: [\u0275\u0275ProvidersFeature([AuthSignalStore]), \u0275\u0275StandaloneFeature], decls: 19, vars: 14, consts: [[1, "w-screen", "h-screen", "flex", "flex-column", "align-items-center", "justify-content-center"], [1, "text-7xl"], [1, "w-full", "flex", "flex-row", "align-items-center", "justify-content-center"], [1, "flex", "flex-column", "align-items-center", "justify-content-around", "h-20rem", "w-4", 3, "formGroup"], [1, "w-full"], ["pInputText", "", "formControlName", "email", 1, "w-full"], [3, "for"], ["label", "password", "styleClass", "w-full", "inputStyleClass", "w-full", "formControlName", "password", 1, "w-12", 3, "toggleMask"], [1, "flex", "flex-column", "w-full", "align-items-center"], ["label", "sign In", "type", "submit", 1, "w-full", 3, "onClick", "disabled", "loading"], ["align", "center", 1, "w-full"], ["label", "sign Up", "severity", "info", "type", "submit", 1, "w-full", 3, "onClick", "disabled", "loading"]], template: function AuthComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "h1", 1);
    \u0275\u0275text(2, "HmmmH");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 2)(4, "form", 3)(5, "p-floatLabel", 4);
    \u0275\u0275element(6, "input", 5);
    \u0275\u0275elementStart(7, "label", 6);
    \u0275\u0275text(8, "Email");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "p-floatLabel", 4);
    \u0275\u0275element(10, "p-password", 7);
    \u0275\u0275elementStart(11, "label", 6);
    \u0275\u0275text(12, "password");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 8)(14, "p-button", 9);
    \u0275\u0275listener("onClick", function AuthComponent_Template_p_button_onClick_14_listener() {
      return ctx.onClickSignIn();
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "p-divider", 10)(16, "b");
    \u0275\u0275text(17, "or");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "p-button", 11);
    \u0275\u0275listener("onClick", function AuthComponent_Template_p_button_onClick_18_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(12, _c06));
    \u0275\u0275property("disabled", ctx.form.invalid || ctx.$signInIsLoading() || ctx.$signUpIsLoading())("loading", ctx.$signInIsLoading());
    \u0275\u0275advance(4);
    \u0275\u0275styleMap(\u0275\u0275pureFunction0(13, _c06));
    \u0275\u0275property("disabled", ctx.form.invalid || ctx.$signInIsLoading() || ctx.$signUpIsLoading())("loading", ctx.$signUpIsLoading());
  }
}, dependencies: [
  ImageModule,
  InputGroupModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuthComponent, { className: "AuthComponent", filePath: "src/app/auth/pages/auth/auth.component.ts", lineNumber: 39 });
})();
export {
  AuthComponent
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-5OSSZ4CA.js.map
